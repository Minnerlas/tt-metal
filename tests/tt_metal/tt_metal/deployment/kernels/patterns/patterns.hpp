...
#define DRAM_PATTERN_CHECKERBOARD 0
#define DRAM_PATTERN_RANDOM 1
#define DRAM_PATTERN_MARCHING_ONES 2
#define DRAM_PATTERN_MARCHING_ZEROES 3
#define DRAM_PATTERN_REVERSIBLE_RANDOM 4
#define DRAM_PATTERN_RANDOM_XOSHIRO128PP 5
#define DRAM_PATTERN_TOGGLE_BITS 6
#define DRAM_PATTERN_SATURATION 7
#define DRAM_PATTERN_MARCHING_ONE_BITS 8
#define DRAM_PATTERN_MARCHING_ZERO_BITS 9
#define DRAM_PATTERN_COUNTER 10
#define DRAM_PATTERN_ADDRESS 11
#define DRAM_PATTERN_BYTEWISE_SSN 12
